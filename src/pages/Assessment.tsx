        ...
        <div className="min-h-screen bg-gray-50">
          <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center">
              <div className="mb-6">
                <div className={`mx-auto w-16 h-16 rounded-full flex items-center justify-center ${percentage >= 70 ? 'bg-green-100' : percentage >= 50 ? 'bg-yellow-100' : 'bg-red-100'
                  }`}>
                  {percentage >= 70 ?
              ...
              <div className="bg-gray-50 rounded-lg p-6 mb-8">
                ...
                {assessmentData?.topicScores.map(topic => (
                  <div key={topic.topic} className="flex justify-between items-center py-2">
                    ...
                    <span className={`font-semibold ${topic.score >= 7 ? 'text-green-600' :
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 mb-6">
            ...
            <div className="flex justify-end">
              <button
                ...
                className={`px-6 py-3 rounded-lg font-medium transition-all duration-200 ${selectedAnswer !== null
