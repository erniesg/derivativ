                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 ${useRichGenerator ? 'bg-green-600' : 'bg-gray-200'
                        }`}
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${useRichGenerator ? 'translate-x-6' : 'translate-x-1'
                          }`}
                      />
                    </button>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        {['worksheet', 'notes', 'assessment'].map((type) => (
                          <button
                            ...
                            className={`p-3 rounded-lg border-2 transition-all duration-200 capitalize ${materialType === type
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {topics.map((topic) => (
                          <button
                            ...
                            className={`p-3 rounded-lg border-2 transition-all duration-200 text-sm ${selectedTopics.includes(topic)
                              ? 'border-green-500 bg-green-50 text-green-700 font-semibold'
                              : 'border-gray-200 hover:border-gray-300 text-gray-700'
                              }`}
                          >
                    ...
                    <button
                      ...
                      className={`w-full py-4 px-6 rounded-lg font-semibold text-lg transition-all duration-200 ${selectedTopics.length > 0 && !isGenerating
